          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="@if(currentUser() === 'marketingmanager' || currentUser() === 'owner' || currentUser() === 'salesmanager' || currentUser() === 'superadmin' || currentUser() === 'executive') {{route(currentUser().'.allUser')}} @endif">Employees</a></li>
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
						<!--begin::Form-->
					<form class="form" action="{{ route(currentUser().'.updateUser') }}" method="POST"
							...
							<div class="col-lg-4">
								...
								<div class="input-group">
									...
									<input type="email" name="email" value="{{ $user->email }}" class="form-control"
										@if(currentUser() !=='superadmin' ) disabled @endif />
								</div>
							</div>
							<div class="col-lg-4">
								...
								<div class="input-group">
									...
									<input name="mobileNumber" type="text" value="{{ $user->mobileNumber }}"
