...
<div class="content-wrapper container-xxl p-0">
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-start mb-0">Edit Advertisement</h2>
	...
	<div class="card">
		<!--begin::Form-->
		<form class="form" action="{{ route(currentUser().'.advertisement.update',$advertisement->id) }}" method="POST" enctype="multipart/form-data">
			@csrf
			@method('put')
			<div class="card-body">
				<div class="form-group row">
					...
					<div class="col-md-4">
						...
						<input type="text" name="link" class="form-control" value="{{old('link',$advertisement->link)}}"/>
					</div>
				</div>
			</div>
