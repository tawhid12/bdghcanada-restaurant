...
<div class="content-wrapper container-xxl p-0">
												...
												<tr role="row">
													...
													<td>
														<div class="d-flex flex-column">
															<span class="fw-bolder mb-25"><img src="{{asset('/')}}storage/app/public/images/advertisement/{{$advertisement->image}}" alt="" class="img-thumbnail thumb-sm mr-1" width="100px"> </span>
														</div>
													</td>
													...
													<td>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu" style="">
																<a class="dropdown-item" href="{{route(currentUser().'.advertisement.edit',[encryptor('encrypt', $advertisement->id)])}}">
																 ...
																 <a class="dropdown-item" onclick="return confirm('Are you sure to delete?')" href="{{route(currentUser().'.advertisement.destroy', [encryptor('encrypt', $advertisement->id)])}}">
	...
	<script>
		...
		if (dt_basic_table.length) {
			...
			$('div.head-label').html('<h4 class="mb-0">Dashboard</h4><div class="breadcrumb-wrapper"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="{{route(currentUser()."Dashboard")}}">{{ encryptor("decrypt", Session::get("username")) }}</a></li><li class="breadcrumb-item"><a href="#">Advertisement</a></li><li class="breadcrumb-item active">List</li></ol></div>');

			$('.card-header').before('<div class="row"><div class="col-xs-12"><a href="{{route(currentUser().".advertisement.create")}}" class="dt-button create-new btn btn-primary"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus me-50 font-small-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>Add New Advertisement</span></a></div></div>');
