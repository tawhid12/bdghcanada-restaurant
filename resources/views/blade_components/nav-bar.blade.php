                       ...
                       /* echo '<pre>';
                        ...
                        <div class="dropdown-menu dropdown-cart-top p-0 dropdown-menu-right shadow-sm border-0">
                            ...
                            <div class="dropdown-cart-top-body border-top p-4">
                                @if(session()->get('cart'))
                                @forelse(session()->get('cart') as $cart_item)
                                <p class="mb-2"><i class="icofont-ui-press text-danger food-item"></i>{{$cart_item['name']}}<span class="float-right text-secondary">${{$cart_item['price']}}</span></p>
                                @empty
                                @endforelse    
                                @endif
